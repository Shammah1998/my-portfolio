            ...
            >
              <div className="relative h-48 sm:h-56 md:h-64 overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-4 sm:p-6 md:p-8">
                  <span className="text-xs text-accent uppercase tracking-widest font-medium mb-1 sm:mb-2">Project {project.id}</span>
              ...
              <div className="p-4 sm:p-6 md:p-8">
                ...
                {activeProject === project.id && (
                  <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-accent/20 animate-fadeIn">
                    ...
                    <p className="text-light/70 text-xs sm:text-sm leading-relaxed">
