...
import { Certificate, certificates } from '../types/Certificate';
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="glass-card p-8 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h1 className="text-3xl font-display font-bold mb-4">{certificate.title}</h1>
            
            <div className="flex flex-wrap gap-4 mb-8">
              <div className="bg-surface/30 px-4 py-2 rounded-md">
                <span className="text-sm text-light/70">Issuer</span>
                <div className="text-lg">{certificate.issuer}</div>
              </div>
              
              <div className="bg-surface/30 px-4 py-2 rounded-md">
                <span className="text-sm text-light/70">Date</span>
                <div className="text-lg">{certificate.date}</div>
              </div>
            </div>
